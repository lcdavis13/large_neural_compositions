...
def fit_and_evaluate_lr_or_mp(data_train, data_valid, data_test, fold_num, score_fns, data_dim, verbosity=0):
    ...
    if num_samples >= data_dim:
        return fit_and_evaluate_linear_regression(data_train, data_valid, data_test, fold_num, score_fns, data_dim, verbosity)
    else:
        return fit_and_evaluate_moore_penrose(data_train, data_valid, data_test, fold_num, score_fns, data_dim, verbosity)
