...
if __name__ == "__main__":
    run_experiments(cli_args=sys.argv[1:], hyperparam_csv="batch/HPsearch_256-random_1k_old.csv") # capture command line arguments, needs to be done explicitly so that when run_experiments is called from other contexts, CLI args aren't accidentally intercepted 
