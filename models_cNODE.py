...
class ODEFunc_cNODE2(nn.Module):  # optimized implementation of cNODE2
    def __init__(self, data_dim):
        ...
        self.fcc1 = nn.Linear(in_features=data_dim, out_features=data_dim, bias=False)
        self.fcc2 = nn.Linear(in_features=data_dim, out_features=data_dim, bias=False)
...
class ODEFunc_cNODE2_NonLinear(nn.Module): 
    def __init__(self, data_dim):
        ...
        self.fcc1 = nn.Linear(in_features=data_dim, out_features=data_dim)
        self.fcc2 = nn.Linear(in_features=data_dim, out_features=data_dim)
